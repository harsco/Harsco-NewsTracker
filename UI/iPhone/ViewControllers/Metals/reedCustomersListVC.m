...
#import "reedCustomersListVC.h"

@interface reedCustomersListVC ()

@end

@implementation reedCustomersListVC
...
- (void)viewDidLoad
{
    ...
    NSMutableArray* temp = [[NSMutableArray alloc] initWithObjects:@"GAF MATERIALS CORP - PARENT",@"OWENS CORNING POSTPETITION-PAR",@"CERTAINTEED CORPORATION - PARE",@"CARLISLE COATINGS & WATERPROOF",@"NORTHERN ELASTOMERIC INC-ROOFI",@"TAMKO ROOFING",@"POLYGLASS USA",@"BITEC INC",@"TARCO OF TEXAS INC  PARENT",@"U S PLY INC",@"OWENS CORNING POSTPETITION",@"HDQ",@"ABH ENTERPRISES INC",@"GAF MATERIALS CORP - HDQTRS-BR",@"G A P ROOFING INC",@"WRIGHT ASPHALT PRODUCTS; CHANN",@"CERTAINTEED CORPORATION - HDQT" ,@"ABH ENTERPRISES INC",@"GAF MATERIALS CORP - HDQTRS-BR",@"G A P ROOFING INC",@"WRIGHT ASPHALT PRODUCTS; CHANN",@"CERTAINTEED CORPORATION - HDQT",nil];
    ...
    [divisionDict setObject:temp1 forKey:@"Key Abrasives Customerss"];
