//
//  industrialHomeViewController.m
//  Germanium
//
...
#import "industrialHomeViewController.h"

@implementation industrialHomeViewController

@synthesize industrialHeader;
@synthesize webActivityIndicator;
@synthesize industrialWebView;
...
- (void)viewDidLoad
{
    ...
    self.industrialHeader.topItem.leftBarButtonItem = backButton;
    
    [self.webActivityIndicator setHidden:NO];
    [self.webActivityIndicator startAnimating];
    
    self.industrialWebView.delegate = self;
    
    [self.industrialWebView loadRequest:
...
-(void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    [self.webActivityIndicator stopAnimating];
    [self.webActivityIndicator setHidden:YES];
    self.industrialWebView.userInteractionEnabled = NO;
