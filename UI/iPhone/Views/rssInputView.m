...
- (id)initWithFrame:(CGRect)frame
{
    if (self == [super initWithFrame:frame]) {               
        ...
        useridtext.placeholder = @"RSS Feed";
        ...
        CGRect pframe = CGRectMake(21.0, 88.0, 244.0, 31.0);
      ...
      //  [self addSubview:passwordtext];
        ...
        //        
        UILabel *lblRememberMsg = [[UILabel alloc] initWithFrame:CGRectMake(26, 88,230, 86)];
        ...
        [lblRememberMsg setText:@"You are entering into High Security Data Zone, Please prove your identity before proceeding further"];
...
- (IBAction)useridtextFieldDone:(id)sender {
    ...
    if ([useridtext.text length] < 1){
        ...
        UIAlertView *someError = [[UIAlertView alloc] initWithTitle: @"User ID" message: @"User Id is blank." delegate: self cancelButtonTitle: @"Ok" otherButtonTitles: nil];
        [someError show];
        [someError release];
    }
...
- (IBAction)passwordtextFieldDone:(id)sender {
	if ([passwordtext.text length] < 1){
        ...
        UIAlertView *someError = [[UIAlertView alloc] initWithTitle: @"Password" message: @"Password is blank." delegate: self cancelButtonTitle: @"Ok" otherButtonTitles: nil];
        [someError show];
        [someError release];
    }
    NSLog(@"Log");
...
- (void)layoutSubviews {
    for (UIView *view in self.subviews) {
        ...
        if ([viewType isEqualToString:@"UIThreePartButton"] || [viewType isEqualToString:@"UIAlertButton"]) {
            ...
            //view.frame =  CGRectMake(30, 40, 300, 50);
        }
    }
}
